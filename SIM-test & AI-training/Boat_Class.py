...
class boat:
  def __init__(self,pos,angle,size,color):
    ...
    self.wind_angles=[0,5,10,15,20,25,32,36,40,45,52,60,70,80,90,100,110,120,130,140,150,160,170,180]
    self.speeds_line=[0.0, 0.5, 1.1, 1.4, 1.9, 2.4, 3.7, 4.3, 4.8, 5.2, 5.8, 6.2, 6.4, 6.6, 6.8, 6.8, 6.7, 6.4, 5.8, 5.2, 4.6, 4.0, 3.6, 3.4]
  ...
  def update(self):
    ...
    self.acc[0] -= sx * sideways_speed * 0.4
    self.acc[1] -= sy * sideways_speed * 0.4
